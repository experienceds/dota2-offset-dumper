// animationsystem.dll  Dota 2 schema dump
#pragma once
#include <cstdint>
...
namespace animationsystem_dll {
    ...
    // CAnimationLayer  size 0x4C
    namespace CAnimationLayer {
        constexpr auto m_hSequence = 0x0; // CAnimNetVar< int32 >
        constexpr auto m_flPrevCycle = 0xC; // float32
        constexpr auto m_flCycle = 0x10; // CAnimNetVar< float32 >
        constexpr auto m_flWeight = 0x1C; // CAnimNetVar< float32 >
        constexpr auto m_nOrder = 0x28; // CAnimNetVar< int32 >
        constexpr auto m_bLooping = 0x34; // bool
        constexpr auto m_nFlags = 0x38; // int32
        constexpr auto m_bSequenceFinished = 0x3C; // bool
        constexpr auto m_flKillRate = 0x40; // float32
        constexpr auto m_flKillDelay = 0x44; // float32
        constexpr auto m_nPriority = 0x48; // int32
    }
