...
namespace CAnimationLayer { // size 0x4C
    constexpr auto m_hSequence = 0x0;
    constexpr auto m_flPrevCycle = 0xC;
    constexpr auto m_flCycle = 0x10;
    constexpr auto m_flWeight = 0x1C;
    constexpr auto m_nOrder = 0x28;
    constexpr auto m_bLooping = 0x34;
    constexpr auto m_nFlags = 0x38;
    constexpr auto m_bSequenceFinished = 0x3C;
    constexpr auto m_flKillRate = 0x40;
    constexpr auto m_flKillDelay = 0x44;
    constexpr auto m_nPriority = 0x48;
}
